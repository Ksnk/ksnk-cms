...
+ добавлена опция depend в теги XML.
 ...
 depend="*.js" - пересборка всех файлов, время сборки которых меньше максимального из
...
-- добавить загрузку параметров из svn.prop при сборке проекта. Для этого нужно
  добавить /Psvn.prop в строку запуска препроцессора
...
var и remove.
  ...
  depend  - маска файлов, по которой определяется максимальное время модификации, или
