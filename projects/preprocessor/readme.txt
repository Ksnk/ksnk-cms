...
---для начала необходимо вставить в каждый файл "заготовку" шапки
 /**
  * simple description why do you need this file in project
  *
  * </%=point('hat','comment');
  ...
  %/>
  */
имеет смысл сделать так, чтобы длина заготовки совпадала по количеству строк с длиной шапки
так как в этом случае при отладке номер строки построенного файла будет совпадать с исходным.
...
-- добавить описание шапки проекта в какой-нибудь файл проекта.
 </% point_start('hat');
