 ...
 * <%=point('hat','jscomment');
// эти пустые строки оставлены дл€ того, чтобы номера строк совпадали   
...
class template_compiler {
	...
	/**
	 * функци€ компил€ции текста. –езультатом будет 
	 * текст функции, дл€ вставки в шаблон 
	 * @param string $tpl
	 */
	...
	/**
	 * проверка даты изменени€ шаблона-образца
	 */
