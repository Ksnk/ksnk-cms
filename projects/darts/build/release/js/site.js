...
$(function(){
	// РІСЃРїР»С‹РІР°СЋС‰РёРµ РјРµРЅСЋС€РєРё (С‚РѕР»СЊРєРѕ РЅР°Рґ Р±Р»РѕРєРѕРІС‹РјРё СЌР»РµРјРµРЅС‚Р°РјРё!!!)
...
$("ul.ulmenu li>a").hover(function(){
	$(this).css({backgroundPosition:'0px 44px'}).animate({backgroundPosition:'0px 40px'});
},function(){
	$(this).stop(true, true).animate({backgroundPosition:'0px 44px'});
})
//
