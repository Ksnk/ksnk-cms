...
/**
 * 
 * внутренний класс для хранения операндов на стеках 
 *
 */
class operand {
	var 
...
//		, $script='' // считается, что не нужен...
	...
	/**
	 * сообщения об ошибках - задел на трансляцию ошибок
	 */	
		, $error_msg=array(
	...
	/**
	 * Создание новой операции. Еще одно единственное место ;)
	 */	
