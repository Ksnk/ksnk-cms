История изменений
 ...
 Sat Jan 12 2008 17:15:41 GMT+0300 (MSK)
+ 	вставлена задержка в 10 секунд, после которой происходит 
	автоматическая передача хода.
+ 	замена простого JsHTTPRequest'а на комплексный

+~- множественные безсистемные улучшения - апгрейды системной части...	
...
Хочется :
 ...
 (Впрочем - раскрашивать-то как раз несложно ;) ) оказалось нетривиально. А когда пришлось еще и цифирки по 
 кругу располагать это и совсем ужас! К счастию, Adobe придумал как прикрутить к своему во многиз отношениях замечательному
 PhotoShop'у JavaScript.
      
 
 К сожаленю, при утягивании картинок появлялись какие-то 
 ...
 -- любой юзер может завести аккаунт.
 -- любой аккаунт может завести новый тир и стать автоматически его владельцем (первый тир делается автоматически?)
 -- любой аккаунт может создать любого другого юзера с не бОльшими правами.
 -- любой аккаунт может передать другому юзеру право на свои тиры (чтение или запись).
 
 У каждого юзера есть список тиров, отношение к которым он имеет.
 
 Каждый тир спрашивает у юзера - имеет ли он право делать с тиром что-то...
 ...
 Авторизация - часть 2.
 при входе юзера в систему производится выбор активного клуба. 
 Либо явный выбор юзера,
 либо первый из спика клубов юзера, 
 либо последний посещенный клуб, сохраняется в настройках 
 аккаунта.
 Идентификатор выбранного клуба является ключем для проверки на право посещения.
 
 Инвайт ссылки - заводится новая запись с информацией о правах пользователя.
 -- клуб посещения
 -- дополнительные права на просмотр таблиц
 -- время окончания действия прав
 -- адрес турнира для просмотра.
 
 Сама ссылка является паролем для входа на сайт.
  
Для существующего аккаунта права подклеиваются к обычным правам пользователя, после 
подклеивания, в случае, если время действия истекает - права аннулируются.
