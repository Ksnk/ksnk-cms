...
class JSYSOPERATION_Login {
	...
	function DoLogin() {
		...
		if ($pass!=$JSYS_PASSWORD) {
			...
			echo "<br><a href='jsys.php?action=Login&task=main'>Return to login form</a>";
			return;
		}
...
class JSYSOPERATION_FileView {
	...
	function SaveFile() {
		...
		echo "<br><a href='jsys.php?action=FileView&DIR=".urlencode($DIR)."'>Return to directory</a>";
	}
	...
	function DoChmod() {
		...
		echo "<br>Operations ended. <a href='jsys.php?action=FileView&DIR=".urlencode($DIR)."'>Return to directory</a>";
	}
...
<tr>
	...
	<a href="jsys.php?action=Main">Start</a> <font color="#8daa94">/</font>
	<a href="jsys.php?action=SetPassword">Change password</a> <font color="#8daa94">/</font>
	<a href="jsys.php?action=Info">Information</a> <font color="#8daa94">/</font>
	<a href="jsys.php?action=FileView">File manager</a> <font color="#8daa94">/</font> 
	<a href="jsys.php?action=Login&task=Logout">Logout</a>  
