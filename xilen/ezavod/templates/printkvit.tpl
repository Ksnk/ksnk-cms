					...
					<tr>
						...
						<table width=100% align=left valign=top cellpadding=0
							...
							<tr>
								...
								{spec_ORGANISATION|ООО Экспериментальный завод трейд}</b></td>
							</tr>
							<tr>
								<td colspan=2 align=center  style="color: #000000;"
							...
							<tr>
								<td align=center style="color: #000000;"
									font-size:10px; ; padding-top:6px>{spec_INN}</td>
								<td align=center style="color: #000000;"
									font-size:10px; ; padding-top:6px>{spec_KPP}</td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan=2 align=center style="color: #000000;"
									font-size:10px; ; padding-top:6px>№{spec_ORDERNUM}</td>
							</tr>
							<tr>
								<td colspan=2 align=center style="color: #000000;"
									font-size:10px; ; padding-top:3px><img src=img/black.gif
							...
							<tr>
								<td colspan=2 align=center style="color: #000000;"
									font-size:10px; ; padding-top:6px>{spec_BANK}</td>
							</tr>
							<tr>
								<td colspan=2 align=center style="color: #000000;"
									font-size:10px; ; padding-top:3px><img src=img/black.gif
							...
							<tr>
								<td colspan=2 align=center style="color: #000000;"
									font-size:10px; ; padding-top:6px>к/с {spec_SORDERNUM}</td>
							</tr>
							<tr>
								<td colspan=2 align=center style="color: #000000;"
									font-size:10px; ; padding-top:3px><img src=img/black.gif
							...
							<tr>
								<td colspan=2 align=center style="color: #000000;"
									font-size:10px; ; padding-top:6px>БИК {spec_BIK}</td>
							</tr>
							<tr>
								<td colspan=2 align=center style="color: #000000;"
									font-size:10px; ; padding-top:3px><img src=img/black.gif
						...
						<table width=100% align=left valign=top cellpadding=0
							...
							<tr>
								<td colspan=2 align=center style="color: #000000;"
									...
									<b>{spec_ORGANISATION|ООО Экспериментальный завод трейд}</b></td>
							</tr>
							<tr>
								<td colspan=2 align=center style="color: #000000;"
									font-size:10px; ; padding-top:3px><img src=img/black.gif
