...
function _(&$par){		
		return tpl::_a($par['qathanks'],array('tpl_users','qathanks')).'
'.tpl::_a($par['onlinereg'],array('tpl_users','onlinereg'));
}

function qathanks(&$par){		
		return '<div style="padding-top:60px; padding-right:0; padding-bottom:0; padding-left:60px;" class="tahoma ctext link">
...
function onlinereg(&$par){		
		return '<form action="" enctype="multipart/form-data" method="POST" name="onlinereg">
<style>
.table td.pad10 {
 padding-top:10px;
 padding-bottom:10px;
