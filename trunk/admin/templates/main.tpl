...
<!--end:txt-->
<!--begin:html-->
<td id="{name}_{id}" class="html_edit"  title="{title}">
{text_breath}
</td>
<!--end:html-->
<!--begin:csv-->
...
<!--begin:article_edit--><tr >
		<th style="padding:2px 5px;"
			...
			class="long wide blue table tahoma size11"><tr><td class="align_middle">
			<input type="submit" disabled="disabled" class="button savebutton" value="сохранить">
			<%=point('plugin_control0')%>
			</td>
		<!--begin:image-->
		...
		<td class="align_middle">
			<input type="submit"
			title="добавить новый элемент" class="button" name="new_item_add" value="Добавить">
		<br><select alt="выбирайте тип нового элемента"  title="выбирайте тип нового элемента" class="tahoma fills size11" name="new_item_type">
		    {options}
			
		</select></td>
			<th class="bblue" style="padding:0;" width="70%" >
