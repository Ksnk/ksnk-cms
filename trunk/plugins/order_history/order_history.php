<?php
/**
 * плагин - истори€ заказов
 * “абличка с именем юзера,
...
class order_history extends plugin {
    ...
    static $STATUS=array(0=>'','active'=>"јктивен",'closed'=>"Ќеактивен",'complete'=>"ќплачен") ;
    static $TYPES=array(0=>'','bnal'=>'Ѕезналичный расчет','kvit'=>' витанци€','nal'=>'оплата в офисе') ;
//    static $TYPES=array('','Ѕезналичный расчет',' витанци€','оплата в офисе') ;
 ...
 * status - статус заказа, если понадобитс€ в будудщем
